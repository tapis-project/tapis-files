...
/**
 * Precompiled edu.utexas.tacc.tapis.java-conventions script plugin.
 **/
public class EduUtexasTaccTapisJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_EduUtexasTaccTapisJavaConventions").asSubclass(BasicScript.class);
