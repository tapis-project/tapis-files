...
public class PermissionsApiResource  {
    ...
    public Response permissionsSystemIdPathDelete(
        ...
        try {
            ...
            String msg = Utils.getMsgAuth("FILES_PERM_ERROR", user, systemId, opName, ex.getMessage());
            log.error(msg, ex);
    ...
    public Response permissionsSystemIdPathGet(
        ...
        try {
            ...
            String msg = Utils.getMsgAuth("FILES_SYSOPS_ERROR", user, systemId, "getSystem", ex.getMessage());
            log.error(msg, ex);
            throw new WebApplicationException(msg, ex);
        }
        if (system == null) {
