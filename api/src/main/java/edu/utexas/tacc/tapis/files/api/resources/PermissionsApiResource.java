...
public class PermissionsApiResource  {
  ...
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "FilePermission", content = @Content(schema = @Schema(implementation = FilePermission.class))) })
  ...
  @ApiResponses(value = {
      @ApiResponse(
          ...
          content = @Content(array = @ArraySchema(schema = @Schema(implementation = FilePermission.class)))) })
  ...
  @ApiResponses(value = {
      @ApiResponse(
          responseCode = "200",
          description = "FilePermission",
          content = @Content(schema = @Schema(implementation = FilePermission.class)))
  })
