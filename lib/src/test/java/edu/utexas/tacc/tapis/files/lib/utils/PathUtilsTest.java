...
public class PathUtilsTest {
    ...
    public void testSimple() {
        ...
        Path p = PathUtils.relativizePathsForTransfer("/a", "/a/1.txt", "/");
    ...
    public void testNotRoot() {
        ...
        Path p = PathUtils.relativizePathsForTransfer("/a", "/a/1.txt", "/b");
    ...
    public void testNested() {
        //Transfer everything from folder /a on source to /b on dest
        Path p = PathUtils.relativizePathsForTransfer("/a", "/a/b/c/1.txt", "/b");
    ...
    public void testNestedDest() {
        ...
        Path p = PathUtils.relativizePathsForTransfer("/a", "/a/b/c/1.txt", "/b/c/d/");
    ...
    public void testNestedSource() {
        ...
        Path p = PathUtils.relativizePathsForTransfer("/a/b/c/", "/a/b/c/1.txt", "/");
        Assert.assertEquals(p, Paths.get("/1.txt"));
    }
