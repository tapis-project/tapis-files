...
//    Assert.assertTrue(shareInfo.getUserSet().contains(testUser3));
          ...
          throws ServiceException, TapisClientException
  {
    ...
    fileOpsService.ls(rTestUser1, sysId, pathToShare, 1, 0, nullImpersonationId, sharedCtxGrantorNull, IRemoteDataClient.NO_PATTERN);
    fileOpsService.ls(rTestUser1, sysId, fileToCheck, 1, 0, nullImpersonationId, sharedCtxGrantorNull, IRemoteDataClient.NO_PATTERN);
    fileOpsService.getFileInfo(rTestUser1, sysId, fileToCheck, true, nullImpersonationId, sharedCtxGrantorNull);
    boolean pass = false;
    try
    {
      fileOpsService.ls(rTestUser2, sysId, pathToShare, 1, 0, nullImpersonationId, sharedCtxGrantorNull, IRemoteDataClient.NO_PATTERN);
    }
    catch (ForbiddenException e) { pass = true; }
    ...
    try
    {
      fileOpsService.ls(rTestUser2, sysId, fileToCheck, 1 , 0, nullImpersonationId, sharedCtxGrantorNull, IRemoteDataClient.NO_PATTERN);
    }
    catch (ForbiddenException e) { pass = true; }
