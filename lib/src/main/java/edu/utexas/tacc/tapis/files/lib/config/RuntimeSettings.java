...
public class RuntimeSettings {
    ...
    static class BaseConfig implements IRuntimeConfig{
        ...
        protected final int dbConnectionPoolCoreSize = getIntSetting("TAPIS_DB_CONNECTION_POOL_CORE_SIZE", 20);
        protected final int dbConnectionPoolSize = getIntSetting("TAPIS_DB_CONNECTION_POOL_SIZE", 30);
