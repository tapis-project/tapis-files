...
public interface SchedulingPolicy {
     ...
     * @throws SchedulingPolicyException
     */
    List<Integer> getQueuedArchiveTransferIds() throws SchedulingPolicyException;
     ...
     * @throws SchedulingPolicyException
     */
    void assignArchiveTransfersToWorkers(List<UUID> workerIds, List<Integer> queuedTaskIds) throws SchedulingPolicyException;
     ...
     * @throws SchedulingPolicyException
     */
    List<PrioritizedObject<ArchiveTransfer>> getArchiveTransfersForWorker(UUID workerUuid) throws SchedulingPolicyException;
